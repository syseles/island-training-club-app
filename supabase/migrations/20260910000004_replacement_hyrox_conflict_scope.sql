-- Island Training Club — scope replacement conflicts to HYROX
--
-- The original acceptance predicate treated every active booking on the
-- target date (including Post-Training Lunch) as a HYROX conflict. Compare
-- only authoritative HYROX cycle/session metadata instead.
