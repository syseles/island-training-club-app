-- Island Training Club — dated WNT meeting-point coordinates
--
-- Extends free-event venue overrides with an optional coordinate pair used
-- only for dated WNT sessions at Tamar Park. The existing four-argument RPC
-- remains available as a compatibility wrapper during static deployment.
