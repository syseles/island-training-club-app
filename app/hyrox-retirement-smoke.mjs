...
assert.equal(isRetiredHyroxBooking({ hyrox_cycle_id: "hyrox-pool-2" }, () => null), true);
...
const bookings = new Map([
  ["pooled-booking", { id: "pooled-booking", cycleId: "hyrox-pool-1" }],
...
assert.equal(isRetiredHyroxReceipt({ cycleId: "hyrox-pool-1" }, getBooking), true);
