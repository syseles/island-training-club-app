# Activity photo sources

The recurring activity images are representative stock photography and do not depict Island Training Club members or sessions.

All three images were retrieved from the official Unsplash image CDN on 2 September 2026 and are used under the [Unsplash License](https://unsplash.com/license). Preserve this record when replacing or redistributing the optimized derivatives.
...
The optimized repository files are 2000 pixels wide. Do not describe these representative images as photos of a named venue or an ITC event.
